...
fn text_options_tab<'a>(
    ...
    column![
        ...
        pick_field(t!("Justification"), justify_opts, justify_sel, |s| {
...
fn properties_tab<'a>(
    ...
    column![
        ...
        pick_field(t!("Linetype"), linetypes, lt_sel, Message::AttrEditorLinetype, width),
        pick_field(t!("Color"), color_opts, color_sel, |s| {
